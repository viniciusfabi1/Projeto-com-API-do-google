		...
		<!-- Main -->
			<section id="main" class="wrapper">
				<div class="inner">
                    ...
                    <form name="form" form method="POST" action="salva_furto.php">
                        <div class="row uniform">
                                          <div class="12u$">
											<div >     
                                               <input type="email" value="Tráfico Intenso" name="denuncia" id="denuncia" readonly/>
											</div>
										</div>
                    
										<div class="6u 12u$(xsmall)">
											<input type="text" name="nome" required maxlength="" id="nome" value="" placeholder="Nome *" required/>
										</div>
										...
										<div class="6u 12u$(xsmall)">
                                         ...
                                         <div class="6u 12u$(xsmall)">
                                            <div>
                                             <label class="lblb1" maxlenght="8">CEP</label><input class="lbl-date1" name="cep" type="number" min="12600005" max="12614899">
                                            </div>
                                        </div>
                                        <div class="12u$">
											<div>     
										...
										<div class="4u 12u$(small)">
											<input type="radio" id="priority-low" name="priority" value= "baixa">
